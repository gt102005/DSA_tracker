...
**DSA Tracker** is a high-performance, responsive React application designed to help developers systematically master 100 essential Data Structures and Algorithms questions. This tool is optimized for interview preparation for top product-based companies, providing a structured approach to learning with a sophisticated **Glassmorphism UI**.

---

## 🛠 Tech Stack

* **Frontend**: [React.js](https://reactjs.org/) (v18.2.0) - Powering the component-based architecture.
...
* **Routing**: [React Router Dom](https://reactrouter.com/) (v6.8.2) - Seamless client-side navigation between topics.
...
* **➕ Custom Problem Entry**: A dedicated "Add Question" interface to expand your personal study sheet beyond the default 100 questions.
* **💡 Motivational Core**: Integrated motivational quotes on the dashboard to keep your spirits high during the grind.
...
1.  **Clone the repository**:
    ```bash
    git clone [https://github.com/Dct-tcd/DSA_tracker.git](https://github.com/Dct-tcd/DSA_tracker.git)
    cd DSA_tracker
    ```
